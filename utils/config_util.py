...
key_xf_tts_app_id = None
key_xf_tts_app_secret = None
key_xf_tts_api_key = None
...
def load_config():
    ...
    global key_xf_tts_app_id
    global key_xf_tts_app_secret
    global key_xf_tts_api_key
    ...
    # 科大讯飞 文字转语音 API
    key_xf_tts_app_id = system_config.get('key', 'xf_tts_app_id')
    key_xf_tts_app_secret = system_config.get('key', 'xf_tts_app_secret')
    key_xf_tts_api_key = system_config.get('key', 'xf_tts_api_key')
