...
class FeiFei:
    def __init__(self):
        pygame.mixer.init()
        self.q_msg = '你叫什么名字？'
        self.a_msg = 'hi，我叫菲菲，英文名是fay，我正在直播带货！'
        self.mood = 0.0  # 情绪值
        self.item_index = 0
            ...
            try:
                ...
                if i <= 3 and len(self.interactive) > i:
                    ...
                    if index == 1:
                        ...
                        self.a_msg = ['欢迎{}'.format(user_name), '感谢{}的到来'.format(user_name), '欢迎{}来到我们的直播间'.format(user_name)][
                            random.randint(0, 2)]
