...
print(os.path.join(os.getcwd(), "test", "ovr_lipsync", "ffmpeg", "bin"))
...
if __name__ == "__main__":
    ...
    viseme_list = lip_sync_generator.generate_visemes("D:\\code\\Fay-fay-sales-edition\\test\\ovr_lipsync\\ovr_lipsync_exe\\fay.mp3")
    # print(viseme_list)
